...
impl TextObjectQuery {
	...
	pub fn capture_nodes<'a>(
		&'a self, capture_name: &str, node: Node<'a>, slice: RopeSlice<'a>, cursor: InactiveQueryCursor,
	...
	pub fn capture_nodes_any<'a>(
		&'a self, capture_names: &[&str], node: Node<'a>, slice: RopeSlice<'a>, mut cursor: InactiveQueryCursor,
	) -> Option<Box<dyn Iterator<Item = CapturedNode<'a>> + 'a>> {
