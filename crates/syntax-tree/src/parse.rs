use {
	crate::{Error, LayerData, Syntax, config::LanguageLoader},
	ropey::RopeSlice,
	std::{mem::take, time::Duration},
	tree_sitter::Parser,
};

impl Syntax {
	pub fn update(
		&mut self, source: RopeSlice, timeout: Duration, edits: &[tree_sitter::InputEdit], loader: &impl LanguageLoader,
	) -> Result<(), Error> {
