use {
	crate::{
		Injection, Language, Layer, Syntax,
		config::{LanguageConfig, LanguageLoader},
		locals::ScopeCursor,
		query_iter::{MatchedNode, QueryIter, QueryIterEvent, QueryLoader},
	},
	arc_swap::ArcSwap,
	ropey::RopeSlice,
	std::{
	...
	tree_sitter::{
		Capture, Grammar, Pattern, QueryMatch,
...
impl HighlightQuery {
	pub(crate) fn new(
		grammar: Grammar, highlight_query_text: &str, local_query_text: &str,
